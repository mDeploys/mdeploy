  ...
  en: {
    ...
    serviceCalculator: {
      ...
      fields: {
        ...
        backendHosting: "Backend Hosting (1500 SAR / Year)",
        webHosting5GB: "Web Hosting 5GB (500 SAR/Year)",
        webHosting10GB: "Web Hosting 10GB (800 SAR/Year)",
        cloudHosting20GB: "Cloud Hosting 20GB (1000 SAR/Year)",
        paymentGateway: "Add Payment Getaway (800 SAR - One time)",
        mailServer: "Setup Mail Server (350 SAR - One time)",
      },
      ...
      breakdownTemplates: {
        ...
        backendHosting: "Backend Hosting (1500 SAR)",
        webHosting5GB: "Web Hosting 5GB (500 SAR)",
        webHosting10GB: "Web Hosting 10GB (800 SAR)",
        cloudHosting20GB: "Cloud Hosting 20GB (1000 SAR)",
        paymentGateway: "Payment Getaway (800 SAR)",
        mailServer: "Mail Server (350 SAR)",
      },
      subtotal: "Subtotal",
  ...
  ar: {
    ...
    serviceCalculator: {
      ...
      fields: {
        ...
        backendHosting: "استضافة Backend (1500 ريال / سنة)",
        webHosting5GB: "استضافة ويب 5GB (500 ريال / سنة)",
        webHosting10GB: "استضافة ويب 10GB (800 ريال / سنة)",
        cloudHosting20GB: "استضافة سحابية 20GB (1000 ريال / سنة)",
        paymentGateway: "بوابة دفع (800 ريال - مرة واحدة)",
        mailServer: "إعداد خادم البريد (350 ريال - مرة واحدة)",
      },
      ...
      breakdownTemplates: {
        ...
        backendHosting: "استضافة Backend (1500 ريال)",
        webHosting5GB: "استضافة ويب 5GB (500 ريال)",
        webHosting10GB: "استضافة ويب 10GB (800 ريال)",
        cloudHosting20GB: "استضافة سحابية 20GB (1000 ريال)",
        paymentGateway: "بوابة دفع (800 ريال)",
        mailServer: "خادم بريد (350 ريال)",
      },
