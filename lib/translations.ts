  ...
  en: {
    ...
    adminLogin: {
      ...
      toast: {
        ...
        hostUnreachable: "Supabase auth host is unreachable. Verify NEXT_PUBLIC_SUPABASE_URL and redeploy.",
  ...
  ar: {
    ...
    adminLogin: {
      ...
      toast: {
        ...
        hostUnreachable: "مضيف مصادقة Supabase غير قابل للوصول. تحقّق من NEXT_PUBLIC_SUPABASE_URL وأعد النشر.",
