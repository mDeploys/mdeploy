export const translations = {
  en: {
    ...
    serviceCalculator: {
      ...
      fields: {
        websitePages: "Front-end Website (250 SAR / Page)",
        webAppPages: "Web App (300 SAR / Page)",
        ecommercePages: "E-Commerce Website (450 SAR / Page)",
        mobileScreens: "Mobile APP (300 SAR / Screen)",
        desktopFunctions: "Desktop App (180 SAR / Function)",
        landingPages: "Landing Page (500 SAR/SET)",
        wordpressTemplates: "WordPress Template (1500 SAR / SET)",
        logoDesigns: "Logo Design (300 SAR/SET)",
        brandingDesigns: "Branding Design (1500 SAR/SET)",
      },
      breakdownTitle: "Cost Breakdown",
      breakdownTemplates: {
        website: "Front-end Website ({count} × 250 SAR)",
        webApp: "Web App ({count} × 300 SAR)",
        ecommerce: "E-Commerce Website ({count} × 450 SAR)",
        mobile: "Mobile APP ({count} × 300 SAR)",
        desktop: "Desktop App ({count} × 180 SAR)",
        landing: "Landing Pages ({count} × 500 SAR)",
        wordpress: "WordPress Templates ({count} × 1500 SAR)",
        logo: "Logo Designs ({count} × 300 SAR)",
        branding: "Branding Designs ({count} × 1500 SAR)",
      },
      subtotal: "Subtotal",
  ...
  ar: {
    ...
    serviceCalculator: {
      ...
      fields: {
        websitePages: "موقع واجهة أمامية (250 ريال / صفحة)",
        webAppPages: "تطبيق ويب (300 ريال / صفحة)",
        ecommercePages: "موقع تجارة إلكترونية (450 ريال / صفحة)",
        mobileScreens: "تطبيق جوال (300 ريال / شاشة)",
        desktopFunctions: "تطبيق سطح المكتب (180 ريال / وظيفة)",
        landingPages: "صفحة هبوط (500 ريال/مجموعة)",
        wordpressTemplates: "قالب ووردبريس (1500 ريال/مجموعة)",
        logoDesigns: "تصميم شعار (300 ريال/مجموعة)",
        brandingDesigns: "تصميم هوية (1500 ريال/مجموعة)",
      },
      breakdownTitle: "تفصيل التكلفة",
      breakdownTemplates: {
        website: "موقع واجهة أمامية ({count} × 250 ريال)",
        webApp: "تطبيق ويب ({count} × 300 ريال)",
        ecommerce: "موقع تجارة إلكترونية ({count} × 450 ريال)",
        mobile: "تطبيق جوال ({count} × 300 ريال)",
        desktop: "تطبيق سطح المكتب ({count} × 180 ريال)",
        landing: "صفحات هبوط ({count} × 500 ريال)",
        wordpress: "قوالب ووردبريس ({count} × 1500 ريال)",
        logo: "تصميم شعار ({count} × 300 ريال)",
        branding: "تصميم هوية ({count} × 1500 ريال)",
      },
